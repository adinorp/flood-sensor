...
#include "drivers/flash/internal/stm32f4xx_flash_driver.h"
#include "debug.h"
...
#ifdef FLASH_SINGLE_BANK
   if(address == STM32F4xx_SECTOR_0_ADDR)
      sector = 0;
   else if(address == STM32F4xx_SECTOR_1_ADDR)
      sector = 1;
   else if(address == STM32F4xx_SECTOR_2_ADDR)
      sector = 2;
   else if(address == STM32F4xx_SECTOR_3_ADDR)
      sector = 3;
   else if(address == STM32F4xx_SECTOR_4_ADDR)
      sector = 4;
   else if(address == STM32F4xx_SECTOR_5_ADDR)
      sector = 5;
   else if(address == STM32F4xx_SECTOR_6_ADDR)
      sector = 6;
   else if(address == STM32F4xx_SECTOR_7_ADDR)
      sector = 7;
#ifndef FLASH_1MB
   else if(address == STM32F4xx_SECTOR_8_ADDR)
      sector = 8;
   else if(address == STM32F4xx_SECTOR_9_ADDR)
      sector = 9;
   else if(address == STM32F4xx_SECTOR_10_ADDR)
      sector = 10;
   else if(address == STM32F4xx_SECTOR_11_ADDR)
      sector = 11;
#endif
#else
   if(address == STM32F4xx_SECTOR_0_ADDR)
      ...
      sector = 7;
#ifdef FLASH_1MB
   else if(address == STM32F4xx_SECTOR_12_ADDR)
      sector = 8;
   else if(address == STM32F4xx_SECTOR_13_ADDR)
      sector = 9;
   else if(address == STM32F4xx_SECTOR_14_ADDR)
      sector = 10;
   else if(address == STM32F4xx_SECTOR_15_ADDR)
      sector = 11;
   else if(address == STM32F4xx_SECTOR_16_ADDR)
      sector = 12;
   else if(address == STM32F4xx_SECTOR_17_ADDR)
      sector = 13;
   else if(address == STM32F4xx_SECTOR_18_ADDR)
      sector = 14;
   else if(address == STM32F4xx_SECTOR_19_ADDR)
      sector = 15;
#else
   else if(address == STM32F4xx_SECTOR_8_ADDR)
      sector = 8;
      ...
      sector = 19;
   else if(address == STM32F4xx_SECTOR_20_ADDR)
      sector = 20;
   else if(address == STM32F4xx_SECTOR_21_ADDR)
      sector = 21;
   else if(address == STM32F4xx_SECTOR_22_ADDR)
      sector = 22;
   else if(address == STM32F4xx_SECTOR_23_ADDR)
      sector = 23;
#endif
#endif
   else

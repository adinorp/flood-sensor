...
//STM32F4xx size
#define STM32F4xx_SIZE 0x100000
//STM32F4xx sectors number
#define STM32F4xx_SECTORS_NUMBER 8

//Flash memory single bank organization
//1 MBytes STM32F4xx Sector start address list (from STM32F7 datasheet)
#define STM32F4xx_SECTOR_0_ADDR   0x08000000 //Base address of Sector 0,  End address at 0x00200000, 32 Kbytes   | 32 Kbytes
#define STM32F4xx_SECTOR_1_ADDR   0x08008000 //Base address of Sector 1,  End address at 0x00208000, 32 Kbytes   | 64 Kbytes
#define STM32F4xx_SECTOR_2_ADDR   0x08010000 //Base address of Sector 2,  End address at 0x00210000, 32 Kbytes   | 96 Kbytes
#define STM32F4xx_SECTOR_3_ADDR   0x08018000 //Base address of Sector 3,  End address at 0x00218000, 32 Kbytes   | 128 Kbytes
#define STM32F4xx_SECTOR_4_ADDR   0x08020000 //Base address of Sector 4,  End address at 0x00220000, 128 Kbytes  | 256 Kbytes
#define STM32F4xx_SECTOR_5_ADDR   0x08040000 //Base address of Sector 5,  End address at 0x00240000, 256 Kbytes  | 512 Kbytes
#define STM32F4xx_SECTOR_6_ADDR   0x08080000 //Base address of Sector 6,  End address at 0x00280000, 256 Kbytes  | 768 Kbytes
#define STM32F4xx_SECTOR_7_ADDR   0x080C0000 //Base address of Sector 7,  End address at 0x002C0000, 256 Kbytes  | 1024 Kbytes
//1 MBytes STM32F4xx Sectors size list (from STM32F7 datasheet)
#define STM32F4xx_SECTOR_0_SIZE   0x8000
#define STM32F4xx_SECTOR_1_SIZE   0x8000
#define STM32F4xx_SECTOR_2_SIZE   0x8000
#define STM32F4xx_SECTOR_3_SIZE   0x8000
#define STM32F4xx_SECTOR_4_SIZE   0x20000
#define STM32F4xx_SECTOR_5_SIZE   0x40000
#define STM32F4xx_SECTOR_6_SIZE   0x40000
#define STM32F4xx_SECTOR_7_SIZE   0x40000

#else

//STM32F4xx size
#define STM32F4xx_SIZE 0x200000
//STM32F4xx sectors number
#define STM32F4xx_SECTORS_NUMBER 12

//2 MBytes STM32F4xx Sector start address list (from STM32F4 datasheet)
#define STM32F4xx_SECTOR_0_ADDR   0x08000000 //Base address of Sector 0,  End address at 0x08007FFF, 32 Kbytes   | 32 Kbytes
#define STM32F4xx_SECTOR_1_ADDR   0x08008000 //Base address of Sector 1,  End address at 0x0800FFFF, 32 Kbytes   | 64 Kbytes
#define STM32F4xx_SECTOR_2_ADDR   0x08010000 //Base address of Sector 2,  End address at 0x08017FFF, 32 Kbytes   | 96 Kbytes
#define STM32F4xx_SECTOR_3_ADDR   0x08018000 //Base address of Sector 3,  End address at 0x0801FFFF, 32 Kbytes   | 128 Kbytes
#define STM32F4xx_SECTOR_4_ADDR   0x08020000 //Base address of Sector 4,  End address at 0x0803FFFF, 128 Kbytes  | 256 Kbytes
#define STM32F4xx_SECTOR_5_ADDR   0x08040000 //Base address of Sector 5,  End address at 0x0807FFFF, 256 Kbytes  | 512 Kbytes
#define STM32F4xx_SECTOR_6_ADDR   0x08080000 //Base address of Sector 6,  End address at 0x080BFFFF, 256 Kbytes  | 768 Kbytes
#define STM32F4xx_SECTOR_7_ADDR   0x080C0000 //Base address of Sector 7,  End address at 0x080FFFFF, 256 Kbytes  | 1024 Kbytes
#define STM32F4xx_SECTOR_8_ADDR   0x08100000 //Base address of Sector 8,  End address at 0x0813FFFF, 256 Kbytes  | 1280 Kbytes
#define STM32F4xx_SECTOR_9_ADDR   0x08140000 //Base address of Sector 9,  End address at 0x0817FFFF, 256 Kbytes  | 1536 Kbytes
#define STM32F4xx_SECTOR_10_ADDR  0x08180000 //Base address of Sector 10, End address at 0x081BFFFF, 256 Kbytes  | 1792 Kbytes
#define STM32F4xx_SECTOR_11_ADDR  0x081C0000 //Base address of Sector 11, End address at 0x081FFFFF, 256 Kbytes  | 2048 Kbytes
//2 MBytes STM32F4xx Sectors size list (from STM32F4 datasheet)
#define STM32F4xx_SECTOR_0_SIZE   0x8000
#define STM32F4xx_SECTOR_1_SIZE   0x8000
#define STM32F4xx_SECTOR_2_SIZE   0x8000
#define STM32F4xx_SECTOR_3_SIZE   0x8000
...
#define STM32F4xx_SECTOR_6_SIZE   0x40000
#define STM32F4xx_SECTOR_7_SIZE   0x40000
#define STM32F4xx_SECTOR_8_SIZE   0x40000
#define STM32F4xx_SECTOR_9_SIZE   0x40000
#define STM32F4xx_SECTOR_10_SIZE  0x40000
#define STM32F4xx_SECTOR_11_SIZE  0x40000
...
//1 MBytes STM32F4xx Sector start address list (from STM32F4 datasheet)
...
#define STM32F4xx_SECTOR_18_ADDR  0x080C0000 //Base address of Sector 18, End address at 0x080EFFFF, 128 Kbytes  | 896 Kbytes
#define STM32F4xx_SECTOR_19_ADDR  0x080E0000 //Base address of Sector 19, End address at 0x080FFFFF, 128 Kbytes  | 1024 Kbytes
//1 MBytes STM32F4xx Sectors size list (from STM32F4 datasheet)

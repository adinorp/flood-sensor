...
#include "drivers/flash/internal/stm32h7xx_flash_driver.h"
#include "debug.h"
...
#if(FLASH_SINGLE_BANK)
    {STM32H7xx_STM32H7xx_FLASH_ADDR, STM32H7xx_FLASH_SECTOR_SIZE, STM32H7xx_FLASH_SECTOR_NUMBER}
#else
...
//error_t stm32h7xxFlashDriverEraseSector(uint32_t firstSector, size_t nbSector);

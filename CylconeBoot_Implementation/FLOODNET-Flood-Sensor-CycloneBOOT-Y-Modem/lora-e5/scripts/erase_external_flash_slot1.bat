...
echo Loading external flash eraser (mode : erase slot1) into internal flash at %LOAD_ADDR%...
%STM32_CUBE_PROGRAMMER_EXE% -c port=SWD index=0 -d ..\..\external_flash_eraser\erase_external_flash_slot1.bin %LOAD_ADDR% -halt -rst -run
